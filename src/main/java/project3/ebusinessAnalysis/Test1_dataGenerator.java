package project3.ebusinessAnalysis;
 ...
 */
public class Test1_dataGenerator {
    ...
    private static void mockLogData(long numberItems, String dataPath) {
        ...
        try {
            printWriter = new PrintWriter(new OutputStreamWriter(
                    new FileOutputStream(dataPath + "Log_Data.log")));
    ...
    private static void mockUserData(long numberItems, String dataPath) {
        ...
        try {
            printWriter = new PrintWriter(new OutputStreamWriter(
                    new FileOutputStream(dataPath + "Users_Data.log")));
